...
const INITIAL: FormData = {
  firstName: "Visa",
  lastName: "Verify",
  displayName: "TheVisaWizard",
  role: "Visa Consultant",
  email: "user@TheVisaWizard.com",
  phone: "+1 (555) 000-0000",
  location: "New York, USA",
  website: "https://TheVisaWizard.com",
  ...
  return (
    <div className="flex flex-col gap-6 sm:gap-8 max-w-3xl mx-auto w-full pb-10">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
          ...
          <div className="flex flex-col gap-1 text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 mt-2">
              <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-[#ede9fe] text-[#7c3aed]">
                Pro Plan
              </span>
              <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-[#d1fae5] text-[#059669]">
                Active
              </span>
            </div>
          </div>
      ...
      <Section
        ...
        description="Update your name, role and display preferences."
      >
