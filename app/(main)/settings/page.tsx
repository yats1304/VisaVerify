  ...
  return (
    <div className="flex items-center justify-between gap-4">
      <div className="flex flex-col gap-0.5 min-w-0">
        ...
        <span className="text-xs text-gray-400 dark:text-slate-500 leading-relaxed">
          {description}
        </span>
      </div>
      <button
...
export default function SettingsPage() {
  ...
  const inputCls =
    "px-3.5 py-2.5 text-sm text-gray-800 dark:text-slate-100 bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-xl outline-none focus:border-[#7c3aed] focus:bg-white dark:focus:bg-slate-700 focus:ring-2 focus:ring-[#7c3aed]/10 transition placeholder:text-gray-400 dark:placeholder:text-slate-500";
    ...
    <div className="flex flex-col gap-6 sm:gap-8 max-w-3xl mx-auto w-full pb-10">
      ...
      >
        <div className="flex flex-col gap-5 divide-y divide-gray-50 dark:divide-slate-800">
          <Toggle
            label="Email — Verification updates"
            description="Get notified when a document is verified or rejected."
            enabled={notifs.emailVerification}
            onChange={() => toggleNotif("emailVerification")}
          />
          <div className="pt-4">
            <Toggle
              label="Email — Product updates"
              description="News, tips and announcements from TheVisaWizard."
              enabled={notifs.emailMarketing}
          ...
          <div className="pt-4">
            <Toggle
              ...
              enabled={notifs.pushAlerts}
              onChange={() => toggleNotif("pushAlerts")}
            />
          </div>
          <div className="pt-4">
            <Toggle
              label="SMS alerts"
              description="Text messages for critical status changes."
          ...
          <div className="pt-4">
            <Toggle
              ...
              description="A digest of your activity sent every Monday."
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-5 pb-5 border-b border-gray-100 dark:border-slate-800">
            <Toggle
              ...
              description="Add an extra layer of security with a one-time code."
              enabled={twoFA}
              onChange={setTwoFA}
            />
            <Toggle
              ...
              {pwSaved && (
                <span className="text-xs font-medium text-[#059669] flex items-center gap-1">
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12Zm13.36-1.814a.75.75 0 1 0-1.22-.872l-3.236 4.53-1.521-1.521a.75.75 0 0 0-1.06 1.06l2.25 2.25a.75.75 0 0 0 1.14-.094l3.647-5.353Z"
                      clipRule="evenodd"
                    />
                  </svg>
                  Password updated
      ...
      <Section
        ...
        description="Adjust how TheVisaWizard looks and formats information."
      >
