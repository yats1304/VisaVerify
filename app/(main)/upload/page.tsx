...
function fileTypeBadge(file: File) {
  if (file.type === "application/pdf")
    return { label: "PDF", color: "#7c3aed", bg: "#ede9fe" };
  if (file.type === "image/jpeg")
    return { label: "JPG", color: "#2563eb", bg: "#dbeafe" };
...
export default function UploadPage() {
  ...
  function addFiles(
    ...
    replaceId: string | null = replacingFileId,
  ) {
  ...
  return (
    ...
    <div className="flex flex-col">
      ...
      >
        {/* Decorative blobs */}
        <div
          className="absolute -top-10 -right-10 w-56 h-56 rounded-full opacity-[0.12]"
          style={{
            background: "radial-gradient(circle, white, transparent 70%)",
          }}
        />
        <div
          className="absolute -bottom-8 left-1/4 w-36 h-36 rounded-full opacity-[0.07]"
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          <p className="text-purple-100 text-sm sm:text-[15px] leading-relaxed">
            Upload your documents and let our AI verify them — results in under
            5 minutes.
          </p>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div className="p-5 sm:p-6">
              <div className="flex items-center gap-2.5 mb-4">
                ...
                <h3 className="font-bold text-gray-900 dark:text-slate-50 text-sm">
                  What We Analyze
                </h3>
              </div>
          ...
          <div className="rounded-2xl border border-amber-100 dark:border-amber-900/20 bg-gradient-to-br from-amber-50 to-orange-50/60 dark:from-amber-950/20 dark:to-orange-950/10 p-5">
            ...
            <p className="text-sm text-amber-700/80 dark:text-amber-300/70 leading-relaxed">
              Verification typically takes 2–3 minutes. You&apos;ll see
              real-time progress updates and can safely navigate away —
              we&apos;ll save your results.
            </p>
          </div>
          ...
          <div className="rounded-2xl border border-purple-100 dark:border-purple-900/20 bg-gradient-to-br from-purple-50 to-blue-50/60 dark:from-purple-950/20 dark:to-blue-950/10 p-5">
            <div className="flex items-center gap-2.5 mb-1.5">
              ...
              <h4 className="font-bold text-[#7c3aed] dark:text-purple-400 text-sm">
                AI-Verified Standards
              </h4>
            </div>
            <p className="text-sm text-purple-700/80 dark:text-purple-300/70 leading-relaxed">
              Our system applies the same verification frameworks and thresholds
              used by immigration authorities worldwide.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-5">
          <div className="bg-white dark:bg-slate-900 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm overflow-hidden">
            ...
            <div className="p-6 sm:p-8 flex flex-col gap-6">
                  ...
                  {files.length === 0 ? (
                    ...
                    <div className="flex flex-col sm:flex-row gap-5 items-center sm:items-stretch text-left w-full">
                      ...
                      <div className="relative aspect-[4/3] w-full sm:w-[180px] shrink-0 rounded-xl overflow-hidden border border-gray-100 dark:border-slate-800 bg-gray-50 dark:bg-slate-900 shadow-sm group/preview">
                        ...
                        <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/preview:opacity-100 transition-opacity duration-200 flex items-center justify-center">
                          ...
                          >
                            ...
                            >
                              ...
                              <path
                                fillRule="evenodd"
                                d="M.664 9.571a1.008 1.008 0 0 0 0 1.03 14.887 14.887 0 0 0 18.672 0 1.008 1.008 0 0 0 0-1.03A14.887 14.887 0 0 0 .664 9.571ZM10 14a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z"
                                clipRule="evenodd"
                              />
                            </svg>
                            Open Document
                        ...
                        <span
                          className="absolute top-2 left-2 px-2 py-0.5 rounded-md text-[10px] font-bold shadow-sm"
                          style={{
                            background: fileTypeBadge(files[0].file).bg,
                            color: fileTypeBadge(files[0].file).color,
                          }}
                        >
                      ...
                      <div className="flex flex-col justify-between flex-1 py-1 min-w-0 w-full">
                        <div>
                          ...
                          <h4
                            className="font-bold text-gray-900 dark:text-slate-50 text-sm truncate mb-1"
                            title={files[0].file.name}
                          >
                            {files[0].file.name}
                          </h4>
                          <p className="text-xs text-gray-400 dark:text-slate-500 leading-relaxed max-w-sm">
                            AI will inspect layout structure, text contents,
                            stamps, signatures, and compliance criteria.
                          </p>
                        </div>
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-3 gap-3.5">
                        {files.map(({ id, file, previewUrl }) => {
                          ...
                          return (
                            <div
                              key={id}
                              className="group/item flex flex-col gap-2 p-2 rounded-xl bg-gray-50 dark:bg-slate-800/40 border border-gray-100 dark:border-slate-800 hover:border-purple-100 dark:hover:border-purple-950/50 hover:bg-white dark:hover:bg-slate-800 transition-all duration-200"
                            >
                              <div className="relative aspect-square rounded-lg overflow-hidden border border-gray-200/60 dark:border-slate-700 bg-white dark:bg-slate-900">
                                ...
                                <span
                                  className="absolute top-1.5 left-1.5 px-1.5 py-0.5 rounded-md text-[9px] font-bold shadow-sm"
                                  style={{
                                    background: badge.bg,
                                    color: badge.color,
                                  }}
                              ...
                              <div className="flex flex-col gap-0.5 px-1 min-w-0">
                                <span
                                  className="text-[11px] font-bold text-gray-800 dark:text-slate-200 truncate"
                                  title={file.name}
                                >
                                  {file.name}
                                </span>
              ...
              {/* Visa Type */}
              <div>
                <label className="text-xs font-semibold text-gray-600 dark:text-slate-400 block mb-2.5">
                  Visa Category
                </label>
                  ...
                  {VISA_TYPES.map((vt) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <span
                          className={`text-sm font-bold leading-tight ${active ? "text-[#7c3aed]" : "text-gray-800 dark:text-slate-100"}`}
                        >
                          {vt.label}
                        </span>
                        <span className="text-xs text-gray-400 dark:text-slate-500">
