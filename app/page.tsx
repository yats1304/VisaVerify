...
export default function LoginPage() {
  return (
    <main className="min-h-screen bg-white dark:bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden transition-colors duration-200">
      {/* Decorative blobs */}
      <div
        aria-hidden="true"
      ...
      {/* Card */}
      <div className="relative w-full max-w-md bg-white dark:bg-slate-900 rounded-2xl shadow-xl border border-gray-100 dark:border-slate-800 px-10 py-12 flex flex-col items-center gap-8">
        {/* Brand mark */}
        ...
        <div className="w-full flex flex-col items-center gap-5">
          <div className="text-center">
            <h2 className="text-lg font-semibold text-gray-800 dark:text-slate-100">Welcome back</h2>
            <p className="text-gray-400 dark:text-slate-500 text-sm mt-0.5">Sign in to continue to your account</p>
          </div>
          <GoogleSignInButton />
        </div>
